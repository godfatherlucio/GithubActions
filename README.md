[![Run App GageWitcig](https://github.com/godfatherlucio/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/godfatherlucio/GithubActions/actions/workflows/run-app.yaml)
